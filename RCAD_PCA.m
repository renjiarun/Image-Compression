...
close all
%%
I1=imread("C:\Users\91949\OneDrive\Desktop\Matlab Programs\MATLAB PROGRAMS 04-10-2023\Matlab programs\kodim07.jpg");
...
%% PCA Implementation
% Assuming your images are stored in variables img1, img2, img3, and img4
...
%% LL Quantisation
% Assuming your data is stored in a matrix named 'LL'. perform PCA
...
nnz(LL_Quantized);
%% HL Quantisation
% Assuming your data is stored in a matrix named 'HL'. perform PCA
...
%% Method 1
grayImage=rgb2gray(imread("C:\Users\91949\OneDrive\Desktop\Matlab Programs\MATLAB PROGRAMS 04-10-2023\Matlab programs\kodim07.jpg"));
[r,c]=size(grayImage);
%figure,imhist(I)
...
%%
imfinfo("C:\Users\91949\OneDrive\Desktop\Matlab Programs\MATLAB PROGRAMS 04-10-2023\Matlab programs\kodim07.jpg")
peaksnr = psnr(I1,I3);
...
in = imfinfo("C:\Users\91949\OneDrive\Desktop\Matlab Programs\MATLAB PROGRAMS 04-10-2023\Matlab programs\kodim07.jpg")
%Compression_Ratio_1 =  in.FileSize/length(matrgb)

% Now compute compression ratio for a single image
fileInfo = dir("C:\Users\91949\OneDrive\Desktop\Matlab Programs\MATLAB PROGRAMS 04-10-2023\Matlab programs\I33.jpg")
...
%class('C:\Users\91949\OneDrive\Desktop\Matlab Programs\MATLAB PROGRAMS 09-04-2023\Matlab programs\Journal Datasets\Kodak\Original\goldhill.jpg');


%size of file in memory/size of file in disc for original to reconstructed image
%CROR= imageInfo.FileSize/imageInfo2.FileSize

%BPP= 8/CROR


Iref1=imread("C:\Users\91949\OneDrive\Desktop\Matlab Programs\MATLAB PROGRAMS 04-10-2023\Matlab programs\kodim07.jpg");
...
figure;
L = 256;
I = imread("C:\Users\91949\OneDrive\Desktop\Matlab Programs\MATLAB PROGRAMS 04-10-2023\Matlab programs\kodim07.jpg");
...
subplot(2, 2, 4); imshow(exp_I); title('\itexp(I)');
%%
%ssimval = ssim(I3,log_I)
%ssimval = ssim(I3,exp_I)
